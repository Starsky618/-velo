...
_TYPE_COPY = {
    ...
    "polarized": {
        ...
        "explanation": "你有 {endurance}% 时间在轻松耐力区、只有 {tempo}% 在中间区，结构接近 80/20，适合做耐力打底、也愿意保留真正刺激的车手。下周重点不是再加中强度，而是守住轻松日的轻松。",
        "actions": [
    ...
    "pyramidal": {
        ...
        "explanation": "耐力占了 {endurance}%、中强度 {tempo}%、高强度 {high}%，是稳健的金字塔底座，适合逐步变强。下周不要急着变成 80/20，先保持底座，同时给一次清楚的高强度刺激。",
        "actions": [
    ...
    "threshold": {
        ...
        "explanation": "你有 {tempo}% 时间压在节奏和阈值区，Z4 偏高说明你经常把训练骑成比赛。下周先把硬骑次数降下来，让高强度更少、更清楚。",
        "actions": [
    ...
    "mixed": {
        ...
        "explanation": "过去 6 周耐力 {endurance}% / 中强度 {tempo}% / 高强度 {high}%，分布不够清楚，可能是活动太杂、强度忽高忽低。下周先把一周安排变简单，让身体知道每一天在练什么。",
        "actions": [
            ("固定轻松骑", "先固定两次 Z2 轻松骑。"),
            ("只留一次强度", "只安排一次明确的强度课。"),
